...
function CommonConfigPanel({ config, onConfigChange }) {
  // 将 rgba 颜色转换为 hex（用于 color input）
        ...
        <div className="config-grid">
          ...
          <div className="form-item">
            ...
            <div className="color-input-wrapper">
              ...
              />
              <span className="color-value">{getNestedValue('tooltip.backgroundColor') || 'rgba(50, 50, 93, 0.88)'}</span>
            </div>
          </div>
          ...
          <div className="form-item">
            ...
            <div className="color-input-wrapper">
              ...
              />
              <span className="color-value">{getNestedValue('tooltip.borderColor') || 'rgba(255, 255, 255, 0.2)'}</span>
            </div>
          </div>
        </div>
      </section>
